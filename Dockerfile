...
RUN --mount=type=cache,target=/var/cache/apt,sharing=locked \
    ...
    openssh-server sudo net-tools lxde-core lxde-icon-theme x11vnc xvfb screen openbox wget curl gzip gnupg2 htop bmon nano lxterminal netcat-openbsd iproute2 ibus ca-certificates \
